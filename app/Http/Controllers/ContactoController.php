...
class ContactoController extends Controller
{
    ...
    {
        //
        $this->validate($request,['nombre'=>'required','apellido'=>'required','numero'=>'required']);
        Contacto::create($request->all());
        return redirect()->route('contacto.index')->with('succes','Registro satisfacctoriamente');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('contacto.index')->with('succes','Registro actualizado');
